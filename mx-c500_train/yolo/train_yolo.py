...
def parse_args():
    ...
    p.add_argument("--model", default="yolo26n.yaml",
                   help="YOLO26 YAML for scratch training, or .pt for fine-tuning")
    ...
    p.add_argument("--name", default="yolo26_train")
...
def main():
    ...
    results = model.train(
        ...
        resume=args.resume, seed=args.seed, cache=args.cache, pretrained=args.pretrained,
    )
